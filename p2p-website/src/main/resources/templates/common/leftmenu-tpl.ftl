<ul id="menu" class="list-group">
    ...
    <li class="list-group-item">
        ...
        <ul>
            <li name="listCanTransferCredit"><a href="/listCanTransferCredit"><span>可转让的债权</span></a></li>
            <li name="listMyTransferCredit"><a href="/listMyTransferCredit"><span>转让中的债权</span></a></li>
        </ul>
    </li>
	<li class="list-group-item">
		...
		<ul class="in">
			...
			<li name="sinaAccount"><a href="/sinaAccount">托管账户</a></li>
			<li name="payPassword"><a href="/payPassword">支付密码</a></li>
