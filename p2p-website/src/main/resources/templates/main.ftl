				...
				<table class="table el-table table-hover">
					<thead>
						<tr>
							...
							<th>还款方式</th>
							<th>借款期限</th>
							<th width="200px">发标时间</th>
							<th width="160px">发标倒计时</th>
						</tr>
					</thead>
					<tbody>
						<#if publishPendngBidRequests?size &gt; 0 >
							<#list publishPendngBidRequests as data>
								<tr>
									...
									<td>${data.publishTime?string('yyyy-MM-dd HH:mm:ss')}</td>
									<td class="countdown" data-time="${data.publishTime?string('MM/dd/yyyy HH:mm:ss')}"></td>
								</tr>
							</#list>
						<#else>
							<tr>
								<td colspan="7" align="center">
									<p class="text-danger">目前暂时没有待发标的借款</p>
								</td>
							</tr>
						</#if>
					</tbody>
