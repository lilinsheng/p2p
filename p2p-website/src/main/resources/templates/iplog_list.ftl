				...
				<div class="col-sm-9">
					<form action="/ipLog" name="searchForm" id="searchForm" class="form-inline" method="post">
						...
						<div class="form-group">
							<label>时间范围</label>
							<input type="text" onclick="WdatePicker()" readonly="readonly" class="form-control beginDate" name="beginDate" value='${(qo.beginDate?string("yyyy-MM-dd"))!}'/>
						</div>
						<div class="form-group">
							<label></label>
							<input type="text" onclick="WdatePicker()" readonly="readonly" class="form-control endDate" name="endDate" value='${(qo.endDate?string("yyyy-MM-dd"))!}'/>
						</div>
						<div class="form-group">
						    <label>状态</label>
