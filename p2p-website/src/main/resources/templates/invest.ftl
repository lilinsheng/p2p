	...
	<div class="container" style="min-height: 500px;">
		...
		<form action="/invest_list" id="searchForm" method="POST">
            ...
            <div style="margin: 20px 0px;">
                ...
                <label class="btn btn-default active">
                    <input type="radio" name="bidRequestType" value="0" autocomplete="off" checked />&emsp;信用标&emsp;
                </label>
                <label class="btn btn-default">
                    <input type="radio" name="bidRequestType" value="1" autocomplete="off" />&emsp;债权标&emsp;
                </label>
            </div>
            </div>
		</form>
		<table class="table el-table table-hover" id="tabList">
