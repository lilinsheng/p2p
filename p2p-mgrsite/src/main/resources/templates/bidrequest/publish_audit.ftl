...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#myModal [name=monthes2Return]").html(data.returnMonthes);
		      ...
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/bidrequest_publishaudit">
					<fieldset>
			        	...
			        	<div class="form-group">
					        	<label class="col-sm-2 control-label" for="totalRewardAmount">发标时间</label>
					        	<div class="col-sm-3">
					        		<input type="text" placeholder="如果为空,立即发标" class="form-control"
										   name="publishTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
					        	</div>
				        </div>
