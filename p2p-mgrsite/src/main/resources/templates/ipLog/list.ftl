		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/ipLog">
					...
					<div class="form-group">
					    <label>登陆时间</label>
					    <input class="form-control beginDate" readonly="readonly" onclick="WdatePicker()" type="text" name="beginDate" value='${(qo.beginDate?string("yyyy-MM-dd"))!}'/>到
					    <input class="form-control endDate" readonly="readonly" onclick="WdatePicker()" type="text" name="endDate" value='${(qo.endDate?string("yyyy-MM-dd"))!}'/>
					</div>
					<div class="form-group">
					    <label>用户类型</label>
